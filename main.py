...
# Background
BG = pygame.transform.scale(pygame.image.load(os.path.join("assets", "new_back.png")), (WIDTH, HEIGHT))
...
def main():
    ...
    def redraw_window():
        ...
        level_label = main_font.render(f"Level: {level}", 1, (240,0,255))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Press the mouse to play", 1, (240,0,255))
